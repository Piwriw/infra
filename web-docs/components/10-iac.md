...
- [Node 模块](../node-module.md)：节点抽象、健康、drain 与 autoscaling。
- [Sandbox 流量路由](../sandbox-traffic-routing.md)：LB、Client Proxy 与 Orchestrator Proxy 的请求链路。
- [Orchestrator 模块](../orchestrator-module.md)：client node 上 system job 的运行时职责。
