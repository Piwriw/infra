...
- **Access Token 即将下线**:flag `disable-e2b-access-token-provisioning` 启用后 `POST /access-tokens` 返 410 Gone。新集成应走 API Key 或 OIDC。详见 [`api-changes-2026.16-2026.28.md`](./api-changes-2026.16-2026.28.md)。
